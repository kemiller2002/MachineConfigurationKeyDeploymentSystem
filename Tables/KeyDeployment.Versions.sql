IF NOT EXISTS(SELECT * FROM sys.tables t join sys.schemas s ON t.name = 'Versions' and s.name = 'KeyDeployment')
BEGIN
	CREATE TABLE KeyDeployment.Versions
	(
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				INSERT INTO KeyDeployment.Versions
				(
					Major
					,Minor
					,Patch
